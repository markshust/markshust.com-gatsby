      ...
      <Layout location={this.props.location} title={siteTitle}>
        <SEO title={siteDescription} />
          <div className="relative py-8 bg-white overflow-hidden">
              <h1 className="mb-8 text-3xl text-center font-extrabold tracking-tight text-gray-900 sm:text-5xl pb-4">Hey, I'm Mark! <span role="img" aria-label="Wave">👋</span></h1>
              <div className="prose text-gray-700 prose-lg">
                  <p>
                      I’ve been following Magento since the early days (version 0.8?). Before Magento, I was an experienced PHP developer with a number of development agencies. Eventually, I learned enough to become a <a href="https://www.zend-zce.com/en/yellow-pages/ZEND014633" target="_blank" rel="noreferrer">Zend Certified Engineer</a>.
                  </p>
                  <p>
                  ...
                  <p>
                      As usage for the project grew, so did the number of questions I received about it. I decided to put together a collection of lessons to teach all of the concepts for <a href="https://m.academy/courses/setup-magento-2-development-environment-docker" target="_blank" rel="noreferrer">setting up a Magento 2 Development environment with Docker</a>. This course became the first contribution to <a href="https://m.academy" target="_blank" rel="noreferrer">M.academy</a>, a training resource I put together to teach everything I know about Magento to others.
                  </p>
                  <p>
                  ...
                  <p>
                      My wish is that you learn to love Magento as much as I do, and became a great developer or architect at that. I promise to do my best, and hope that one day you can <Link to="/2019/10/29/let-magento-kill-you/">let Magento kill you</Link> too.
                  </p>
                  <p>
                      Keep coding,<br />
                      - Mark
